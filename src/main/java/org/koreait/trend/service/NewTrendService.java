...
//import org.koreait.trend.enties.NewTrend;
...
//                   return  om.readValue(json, NewTrend.class);
//                } else {
...
//        NewTrend item = process();
//        if(item == null) return;
//        String wordclund = String.format("%s%s/trend/%s", request.getContextPath() , fileProperties.getUrl , item.getImage());
//
//        try {
